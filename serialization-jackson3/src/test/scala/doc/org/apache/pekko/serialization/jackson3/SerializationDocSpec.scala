...
object SerializationDocSpec {
  ...
  val configSeveral = """
    ...
    pekko.actor {
      serializers {
        jackson-json-message = "org.apache.pekko.serialization.jackson3.JacksonJsonSerializer"
        jackson-json-event   = "org.apache.pekko.serialization.jackson3.JacksonJsonSerializer"
      }
...
class SerializationDocSpec
    ...
    pekko.serialization.jackson.migrations {
        ...
        "jdoc.org.apache.pekko.serialization.jackson3.v2a.Customer" = "jdoc.org.apache.pekko.serialization.jackson3.v2a.CustomerMigration"
        "jdoc.org.apache.pekko.serialization.jackson3.v1.OrderAdded" = "jdoc.org.apache.pekko.serialization.jackson3.v2a.OrderPlacedMigration"

        # migrations for Scala classes
        "doc.org.apache.pekko.serialization.jackson3.v2b.ItemAdded" = "doc.org.apache.pekko.serialization.jackson3.v2b.ItemAddedMigration"
        "doc.org.apache.pekko.serialization.jackson3.v2c.ItemAdded" = "doc.org.apache.pekko.serialization.jackson3.v2c.ItemAddedMigration"
        "doc.org.apache.pekko.serialization.jackson3.v2a.Customer" = "doc.org.apache.pekko.serialization.jackson3.v2a.CustomerMigration"
        "doc.org.apache.pekko.serialization.jackson3.v1.OrderAdded" = "doc.org.apache.pekko.serialization.jackson3.v2a.OrderPlacedMigration"
    }
    pekko.actor {
      allow-java-serialization = off
      serialization-bindings {
        "${classOf[jdoc.org.apache.pekko.serialization.jackson3.MySerializable].getName}" = jackson-json
        "${classOf[doc.org.apache.pekko.serialization.jackson3.MySerializable].getName}" = jackson-json
      }
    }
    """)))
  ...
  "serialize trait + case classes" in {
    import doc.org.apache.pekko.serialization.jackson3.SerializationDocSpec.Polymorphism._
  ...
  "serialize trait + case classes + case object" in {
    import doc.org.apache.pekko.serialization.jackson3.SerializationDocSpec.PolymorphismMixedClassObject._
    verifySerialization(Zoo(Lion("Simba"))) should ===(Zoo(Lion("Simba")))
    verifySerialization(Zoo(Elephant("Dumbo", 1))) should ===(Zoo(Elephant("Dumbo", 1)))
  ...
  "EventMigration doc sample Java classes" must {
    import jdoc.org.apache.pekko.serialization.jackson3.v1.OrderAdded
    import jdoc.org.apache.pekko.serialization.jackson3.v2a.Customer
    import jdoc.org.apache.pekko.serialization.jackson3.v2a.ItemAdded
    import jdoc.org.apache.pekko.serialization.jackson3.v2a.OrderPlaced

    "test add optional field" in {
      val event1 =
        new jdoc.org.apache.pekko.serialization.jackson3.v1.ItemAdded("123", "ab123", 2)
    ...
    "test add mandatory field" in {
      ...
      val event2 = serializer
        .fromBinary(blob, classOf[jdoc.org.apache.pekko.serialization.jackson3.v2b.ItemAdded].getName)
        .asInstanceOf[jdoc.org.apache.pekko.serialization.jackson3.v2b.ItemAdded]
      event2.quantity should ===(event1.quantity)
      event2.discount should be(0.0 +- 0.000001)

      verifySerialization(new jdoc.org.apache.pekko.serialization.jackson3.v2b.ItemAdded("123", "ab123", 2, 0.1))
    }
    ...
    "test rename field" in {
      ...
      val blob = serializer.toBinary(event1)
      val event2 = serializer
        .fromBinary(blob, classOf[jdoc.org.apache.pekko.serialization.jackson3.v2c.ItemAdded].getName)
        .asInstanceOf[jdoc.org.apache.pekko.serialization.jackson3.v2c.ItemAdded]
    ...
    "test structural changes" in {
      val cust1 =
        new jdoc.org.apache.pekko.serialization.jackson3.v1.Customer("A", "B", "C", "D", "E")
  ...
  "EventMigration doc sample Scala classes" must {
    import doc.org.apache.pekko.serialization.jackson3.v1.OrderAdded
    import doc.org.apache.pekko.serialization.jackson3.v2a.Customer
    import doc.org.apache.pekko.serialization.jackson3.v2a.ItemAdded
    import doc.org.apache.pekko.serialization.jackson3.v2a.OrderPlaced

    "test add optional field" in {
      val event1 =
        doc.org.apache.pekko.serialization.jackson3.v1.ItemAdded("123", "ab123", 2)
      val serializer = serializerFor(event1)
      val blob = serializer.toBinary(event1)
      val event2 = serializer.fromBinary(blob, classOf[ItemAdded].getName).asInstanceOf[ItemAdded]
      event2.quantity should ===(event1.quantity)
    ...
    "test add mandatory field" in {
      ...
      val blob = serializer.toBinary(event1)
      val event2 = serializer
        .fromBinary(blob, classOf[doc.org.apache.pekko.serialization.jackson3.v2b.ItemAdded].getName)
        .asInstanceOf[doc.org.apache.pekko.serialization.jackson3.v2b.ItemAdded]
      event2.quantity should ===(event1.quantity)
      event2.discount should be(0.0 +- 0.000001)

      verifySerialization(doc.org.apache.pekko.serialization.jackson3.v2b.ItemAdded("123", "ab123", 2, 0.1))
    }
    ...
    "test rename field" in {
      ...
      val blob = serializer.toBinary(event1)
      val event2 = serializer
        .fromBinary(blob, classOf[doc.org.apache.pekko.serialization.jackson3.v2c.ItemAdded].getName)
        .asInstanceOf[doc.org.apache.pekko.serialization.jackson3.v2c.ItemAdded]
      event2.itemId should ===(event1.productId)
      event2.quantity should ===(event1.quantity)
    }
    ...
    "test structural changes" in {
      val cust1 =
        doc.org.apache.pekko.serialization.jackson3.v1.Customer("A", "B", "C", "D", "E")
      val serializer = serializerFor(cust1)
      val blob = serializer.toBinary(cust1)
      val cust2 = serializer.fromBinary(blob, classOf[Customer].getName).asInstanceOf[Customer]
      cust2.name should ===(cust1.name)
