...
import tools.jackson.core.json.{ JsonReadFeature, JsonWriteFeature }
...
object JacksonObjectMapperProvider extends ExtensionId[JacksonObjectMapperProvider] with ExtensionIdProvider {
  ...
  private def isModuleEnabled(fqcn: String, dynamicAccess: DynamicAccess): Boolean =
    fqcn match {
      case "org.apache.pekko.serialization.jackson3.PekkoTypedJacksonModule" =>
      ...
      case "org.apache.pekko.serialization.jackson3.PekkoStreamJacksonModule" =>
