...
object DurableProducerQueue {
   ...
   * INTERNAL API
   */
  @InternalApi private[pekko] sealed trait Event extends DeliverySerializable
  ...
  object MessageSent {
     ...
     * INTERNAL API
     */
    @InternalApi private[pekko] def fromChunked[A](
        seqNr: SeqNr,
     ...
     * INTERNAL API
     */
    @InternalApi private[pekko] def fromMessageOrChunked[A](
        seqNr: SeqNr,
   ...
   */
  @InternalApi private[pekko] final case class Confirmed(
      seqNr: SeqNr,
      confirmationQualifier: ConfirmationQualifier,
      timestampMillis: TimestampMillis)
      extends Event
   ...
   */
  @InternalApi private[pekko] final case class Cleanup(confirmationQualifiers: Set[String]) extends Event
