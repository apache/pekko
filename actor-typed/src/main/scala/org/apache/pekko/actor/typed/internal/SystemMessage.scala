 ...
 */
private[pekko] sealed trait SystemMessage extends Serializable {
 ...
 */
@SerialVersionUID(1L)
private[pekko] final case class Create() extends SystemMessage

/**
 * INTERNAL API
 */
@SerialVersionUID(1L)
private[pekko] final case class Terminate() extends SystemMessage

/**
 * INTERNAL API
 */
@SerialVersionUID(1L)
private[pekko] final case class Watch(watchee: ActorRef[Nothing], watcher: ActorRef[Nothing]) extends SystemMessage

/**
 * INTERNAL API
 */
@SerialVersionUID(1L)
private[pekko] final case class Unwatch(watchee: ActorRef[Nothing], watcher: ActorRef[Nothing]) extends SystemMessage

/**
 * INTERNAL API
 */
@SerialVersionUID(1L)
private[pekko] final case class DeathWatchNotification(actor: ActorRef[Nothing], failureCause: Throwable)
