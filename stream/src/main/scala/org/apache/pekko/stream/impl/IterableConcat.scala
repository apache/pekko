...
/**
 * Concatenating an iterable / iterator / range / java-stream-backed source to a stream
 * is common enough that it warrants this optimization which avoids the actual fan-out
