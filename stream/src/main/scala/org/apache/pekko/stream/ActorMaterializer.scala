...
object ActorMaterializerSettings {
   ...
   * See migration guide for details https://pekko.apache.org/docs/pekko/2.6/project/migration-guide-2.5.x-2.6.x.html"
   */
  @deprecated(
    "Use config or attributes to configure the materializer. See migration guide for details https://pekko.apache.org/docs/pekko/2.6/project/migration-guide-2.5.x-2.6.x.html",
    "2.6.0")
  def apply(
