 ...
 * INTERNAL API
 */
@InternalApi private[pekko] class SubReceive(initial: Actor.Receive) extends Actor.Receive {
 ...
 * INTERNAL API
 */
@InternalApi private[pekko] trait Inputs {
 ...
 * INTERNAL API
 */
@InternalApi private[pekko] trait DefaultInputTransferStates extends Inputs {
 ...
 * INTERNAL API
 */
@InternalApi private[pekko] trait Outputs {
 ...
 * INTERNAL API
 */
@InternalApi private[pekko] trait DefaultOutputTransferStates extends Outputs {
 ...
 * INTERNAL API
 */
@InternalApi private[pekko] trait TransferState {
  def isReady: Boolean
 ...
 * INTERNAL API
 */
@InternalApi private[pekko] object Completed extends TransferState {
  def isReady = false
 ...
 * INTERNAL API
 */
@InternalApi private[pekko] object NotInitialized extends TransferState {
  def isReady = false
  def isCompleted = false
}
 ...
 * INTERNAL API
 */
@InternalApi private[pekko] case class WaitingForUpstreamSubscription(remaining: Int, andThen: TransferPhase)
 ...
 * INTERNAL API
 */
@InternalApi private[pekko] object Always extends TransferState {
  def isReady = true
  def isCompleted = false
}
 ...
 * INTERNAL API
 */
@InternalApi private[pekko] final case class TransferPhase(precondition: TransferState)(val action: () => Unit)

/**
 * INTERNAL API
 */
@InternalApi private[pekko] trait Pump {
