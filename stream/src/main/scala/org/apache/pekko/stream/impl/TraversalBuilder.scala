 ...
 * the traversal. See [[MaterializeAtomic]] and comments in org.apache.pekko.stream.impl.package for more details.
 */
@InternalApi private[pekko] sealed trait Traversal {
 ...
 */
@InternalApi private[pekko] final case class Concat(first: Traversal, next: Traversal) extends Traversal {
 ...
 */
@InternalApi private[pekko] final case class MaterializeAtomic(module: AtomicModule[Shape, Any], outToSlots: Array[Int])
    extends Traversal {
 ...
 */
@InternalApi private[pekko] object EmptyTraversal extends Traversal {
 ...
 * INTERNAL API
 */
@InternalApi private[pekko] sealed trait MaterializedValueOp extends Traversal

/**
 * INTERNAL API
 */
@InternalApi private[pekko] case object Pop extends MaterializedValueOp

/**
 * INTERNAL API
 */
@InternalApi private[pekko] case object PushNotUsed extends MaterializedValueOp

/**
 * INTERNAL API
 */
@InternalApi private[pekko] final case class Transform(mapper: AnyFunction1) extends MaterializedValueOp {
 ...
 * INTERNAL API
 */
@InternalApi private[pekko] final case class PushAttributes(attributes: Attributes) extends Traversal

/**
 * INTERNAL API
 */
@InternalApi private[pekko] case object PopAttributes extends Traversal

/**
 * INTERNAL API
 */
@InternalApi private[pekko] final case class EnterIsland(islandTag: IslandTag) extends Traversal

/**
 * INTERNAL API
 */
@InternalApi private[pekko] case object ExitIsland extends Traversal

/**
 * INTERNAL API
 */
@InternalApi private[pekko] object TraversalBuilder {
   ...
   */
  @InternalApi private[pekko] def atomic(module: AtomicModule[Shape, Any], attributes: Attributes): TraversalBuilder = {
 ...
 * See [[CompositeTraversalBuilder]] and [[LinearTraversalBuilder]], also comments in org.apache.pekko.stream.impl.package for more details.
 */
@DoNotInherit private[pekko] sealed trait TraversalBuilder {
 ...
 * See comments in org.apache.pekko.stream.impl.package for more details.
 */
@InternalApi private[pekko] final case class CompletedTraversalBuilder(
 ...
 * See comments in org.apache.pekko.stream.impl.package for more details.
 */
@InternalApi private[pekko] final case class AtomicTraversalBuilder(
 ...
 * See comments in org.apache.pekko.stream.impl.package for more details.
 */
@InternalApi private[pekko] final case class LinearTraversalBuilder(
 ...
 * INTERNAL API
 */
@DoNotInherit private[pekko] sealed trait TraversalBuildStep
 ...
 * See comments in org.apache.pekko.stream.impl.package for more details.
 */
@InternalApi private[pekko] final class BuilderKey extends TraversalBuildStep {
 ...
 * INTERNAL API
 */
@InternalApi private[pekko] final case class AppendTraversal(traversal: Traversal) extends TraversalBuildStep
 ...
 */
@InternalApi private[pekko] final case class CompositeTraversalBuilder(
