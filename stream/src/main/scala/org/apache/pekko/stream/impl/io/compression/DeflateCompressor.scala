...
/** INTERNAL API */
@InternalApi private[pekko] class DeflateCompressor(level: Int = Deflater.BEST_COMPRESSION, nowrap: Boolean = false)
    extends Compressor {
...
/** INTERNAL API */
@InternalApi private[pekko] object DeflateCompressor {
