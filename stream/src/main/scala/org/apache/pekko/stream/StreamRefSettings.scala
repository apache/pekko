...
object StreamRefSettings {
  ...
  /** Java API */
  @deprecated(
    "Use attributes on the Runnable graph or change the defaults in configuration, see migration guide for details https://pekko.apache.org/docs/akka/2.6/project/migration-guide-2.5.x-2.6.x.html",
    since = "2.6.0")
