 ...
 * INTERNAL API
 */
private[pekko] final class ResizablePoolCell(
  ...
  private[pekko] def resize(initial: Boolean): Unit = {
 ...
 * INTERNAL API
 */
private[pekko] object ResizablePoolActor {
 ...
 * INTERNAL API
 */
private[pekko] class ResizablePoolActor(supervisorStrategy: SupervisorStrategy)
