...
@deprecated("Moved to akka.serialization.LongSerializer in pekko-actor", "2.6.0")
...
@deprecated("Moved to akka.serialization.IntSerializer in pekko-actor", "2.6.0")
...
@deprecated("Moved to akka.serialization.StringSerializer in pekko-actor", "2.6.0")
...
@deprecated("Moved to akka.serialization.ByteStringSerializer in pekko-actor", "2.6.0")
