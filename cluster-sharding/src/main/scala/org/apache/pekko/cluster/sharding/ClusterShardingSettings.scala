...
object ClusterShardingSettings {
   ...
   */
  @InternalApi
  private[pekko] val RememberEntitiesStoreCustom = "custom"

  /**
   * INTERNAL API
   */
  @InternalApi
  private[pekko] val RememberEntitiesStoreDData = "ddata"

  /**
   * INTERNAL API
   */
  @InternalApi
  private[pekko] val RememberEntitiesStoreEventsourced = "eventsourced"
  ...
  def apply(config: Config): ClusterShardingSettings = {
    ...
    val passivationStrategySettings = PassivationStrategySettings(config.getConfig("passivation"))
   ...
   */
  @InternalApi
  private[pekko] sealed trait PassivationStrategy

  /**
   * INTERNAL API
   */
  @InternalApi
  private[pekko] case object NoPassivationStrategy extends PassivationStrategy

  /**
   * INTERNAL API
   */
  @InternalApi
  private[pekko] object IdlePassivationStrategy {
   ...
   */
  @InternalApi
  private[pekko] case class IdlePassivationStrategy(timeout: FiniteDuration, interval: FiniteDuration)
   ...
   */
  @InternalApi
  private[pekko] object LeastRecentlyUsedPassivationStrategy {
    def apply(
   ...
   */
  @InternalApi
  private[pekko] case class MostRecentlyUsedPassivationStrategy(limit: Int, idle: Option[IdlePassivationStrategy])
      extends PassivationStrategy
   ...
   */
  @InternalApi
  private[pekko] case class LeastFrequentlyUsedPassivationStrategy(
      limit: Int,
   ...
   */
  @InternalApi
  private[pekko] case class CompositePassivationStrategy(
      limit: Int,
   ...
   */
  @InternalApi
  private[pekko] object PassivationStrategy {
...
final class ClusterShardingSettings(
  ...
  @InternalApi
  private[pekko] val passivationStrategy: ClusterShardingSettings.PassivationStrategy =
