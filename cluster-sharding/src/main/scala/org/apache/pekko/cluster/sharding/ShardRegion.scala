...
object ShardRegion {
   ...
   *
   * [[pekko.actor.PoisonPill]] is a perfectly fine `stopMessage`.
   */
   ...
   */
  @InternalApi
  private[pekko] object GetShardRegionStatus extends ShardRegionQuery
   ...
   */
  @InternalApi
  private[pekko] final class ShardRegionStatus(val typeName: String, val registeredWithCoordinator: Boolean)
   ...
   */
  @InternalApi
  private[pekko] final case class ShardsUpdated(activeShards: Int) extends DeadLetterSuppression
   ...
   */
  @InternalApi private[pekko] class HandOffStopper(
      typeName: String,
      shard: String,
      replyTo: ActorRef,
   ...
   * INTERNAL API
   */
  @InternalApi private[pekko] object HandOffStopper {
