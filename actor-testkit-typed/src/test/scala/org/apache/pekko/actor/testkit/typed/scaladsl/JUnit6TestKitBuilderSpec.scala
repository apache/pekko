...
class JUnit6TestKitBuilderSpec extends AnyWordSpec {

  "the JUnit6TestKitBuilder" should {
    "create a Testkit with name hello" in {
      val actualTestKit = new JUnit6TestKitBuilder().withName("hello").build()
  ...
  "the JUnit6TestKitBuilder" should {
    "create a Testkit with the classname as name" in {
      val actualTestKit = new JUnit6TestKitBuilder()
        .build()

      assertResult("JUnit6TestKitBuilderSpec")(actualTestKit.system.name)
    }
  }
