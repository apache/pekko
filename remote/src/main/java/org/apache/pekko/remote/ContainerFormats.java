...
public final class ContainerFormats extends org.apache.pekko.protobufv3.internal.GeneratedFile {
  ...
  public enum PatternType
    ...
    public static org.apache.pekko.protobufv3.internal.Descriptors.EnumDescriptor
        getDescriptor() {
      return org.apache.pekko.remote.ContainerFormats.getDescriptor().getEnumType(0);
    }
  ...
  private static final long serialVersionUID = 0L;
    ...
    public int getSerializedSize() {
      ...
      if (((bitField0_ & 0x00000002) != 0)) {
        size += org.apache.pekko.protobufv3.internal.CodedOutputStream
          ...
          {
            final int count = pattern_.size();
            for (int i = 0; i < count; i++) {
              size += org.apache.pekko.protobufv3.internal.CodedOutputStream
                .computeMessageSizeNoTag(pattern_.get(i));
            }
            size += 1 * count;
          }
      if (((bitField0_ & 0x00000004) != 0)) {
    ...
    public static final class Builder extends
            ...
            if (patternBuilder_.isEmpty()) {
              ...
              patternBuilder_ = 
                org.apache.pekko.protobufv3.internal.GeneratedMessage.alwaysUseFieldBuilders ?
                   internalGetPatternFieldBuilder() : null;
            } else {
      ...
      public org.apache.pekko.remote.ContainerFormats.Selection.Builder getPatternBuilder(
          int index) {
        return internalGetPatternFieldBuilder().getBuilder(index);
      }
      /**
       * <code>repeated .Selection pattern = 3;</code>
       */
      ...
      public org.apache.pekko.remote.ContainerFormats.Selection.Builder addPatternBuilder() {
        return internalGetPatternFieldBuilder().addBuilder(
      ...
      public java.util.List<org.apache.pekko.remote.ContainerFormats.Selection.Builder> 
        ...
        return internalGetPatternFieldBuilder().getBuilderList();
      }
      private org.apache.pekko.protobufv3.internal.RepeatedFieldBuilder<
    ...
    public static final class Builder extends
      ...
      private void maybeForceBuilderInitialization() {
        if (org.apache.pekko.protobufv3.internal.GeneratedMessage
          ...
          internalGetMessageIdFieldBuilder();
        }
      }
      @java.lang.Override
      public Builder clear() {
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 10: {
                input.readMessage(
                    internalGetMessageIdFieldBuilder().getBuilder(),
                    extensionRegistry);
                bitField0_ |= 0x00000001;
                break;
              } // case 10
      ...
      public org.apache.pekko.remote.ContainerFormats.Payload.Builder getMessageIdBuilder() {
        bitField0_ |= 0x00000001;
        onChanged();
        return internalGetMessageIdFieldBuilder().getBuilder();
      }
      /**
       * <code>required .Payload messageId = 1;</code>
       */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      private void maybeForceBuilderInitialization() {
        if (org.apache.pekko.protobufv3.internal.GeneratedMessage
                .alwaysUseFieldBuilders) {
          internalGetCorrelationIdFieldBuilder();
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 10: {
                input.readMessage(
                    internalGetCorrelationIdFieldBuilder().getBuilder(),
                    extensionRegistry);
                bitField0_ |= 0x00000001;
                break;
              } // case 10
      ...
      public org.apache.pekko.remote.ContainerFormats.Payload.Builder getCorrelationIdBuilder() {
        bitField0_ |= 0x00000001;
        onChanged();
        return internalGetCorrelationIdFieldBuilder().getBuilder();
      }
      /**
       * <code>required .Payload correlationId = 1;</code>
       */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public int getSerializedSize() {
      ...
      if (((bitField0_ & 0x00000004) != 0)) {
        size += org.apache.pekko.protobufv3.internal.CodedOutputStream
          ...
          {
            final int count = stackTrace_.size();
            for (int i = 0; i < count; i++) {
              size += org.apache.pekko.protobufv3.internal.CodedOutputStream
                .computeMessageSizeNoTag(stackTrace_.get(i));
            }
            size += 1 * count;
          }
      size += getUnknownFields().getSerializedSize();
    ...
    public static final class Builder extends
        ...
        if (stackTraceBuilder_ == null) {
          ...
          if (!other.stackTrace_.isEmpty()) {
            if (stackTraceBuilder_.isEmpty()) {
              ...
              stackTraceBuilder_ = 
                org.apache.pekko.protobufv3.internal.GeneratedMessage.alwaysUseFieldBuilders ?
                   internalGetStackTraceFieldBuilder() : null;
            } else {
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 26: {
                input.readMessage(
                    internalGetCauseFieldBuilder().getBuilder(),
                    extensionRegistry);
                bitField0_ |= 0x00000004;
                break;
              } // case 26
      ...
      public org.apache.pekko.remote.ContainerFormats.StackTraceElement.Builder getStackTraceBuilder(
          int index) {
        return internalGetStackTraceFieldBuilder().getBuilder(index);
      }
      /**
       * <code>repeated .StackTraceElement stackTrace = 4;</code>
       */
      ...
      public org.apache.pekko.remote.ContainerFormats.StackTraceElement.Builder addStackTraceBuilder() {
        return internalGetStackTraceFieldBuilder().addBuilder(
      ...
      public java.util.List<org.apache.pekko.remote.ContainerFormats.StackTraceElement.Builder> 
        ...
        return internalGetStackTraceFieldBuilder().getBuilderList();
      }
      private org.apache.pekko.protobufv3.internal.RepeatedFieldBuilder<
