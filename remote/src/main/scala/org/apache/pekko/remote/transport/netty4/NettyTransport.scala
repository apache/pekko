 ...
 */
@nowarn("msg=deprecated")
private[netty4] trait CommonHandlers extends NettyHelpers {
 ...
 */
@nowarn("msg=deprecated")
private[netty4] abstract class ServerHandler(
 ...
 */
@nowarn("msg=deprecated")
private[netty4] abstract class ClientHandler(protected final val transport: NettyTransport, remoteAddress: Address)
