...
object PersistentActorBoundedStashingSpec {
  ...
  val discardConfig = String.format(templateConfig, "org.apache.pekko.persistence.DiscardConfigurator")
  val replyToConfig =
    String.format(templateConfig,
      "org.apache.pekko.persistence.PersistentActorBoundedStashingSpec$ReplyToWithRejectConfigurator")
