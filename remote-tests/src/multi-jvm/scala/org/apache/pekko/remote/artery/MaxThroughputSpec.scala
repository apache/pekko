  ...
  val cfg = ConfigFactory.parseString(s"""
     ...
     pekko {
       ...
       actor {
         ...
         serializers {
           test = "org.apache.pekko.remote.artery.MaxThroughputSpec$$TestSerializer"
           test-message = "org.apache.pekko.remote.artery.TestMessageSerializer"
         }
         serialization-bindings {
           "org.apache.pekko.remote.artery.MaxThroughputSpec$$FlowControl" = test
           "org.apache.pekko.remote.artery.TestMessage" = test-message
         }
       }
       remote.artery {
         enabled = on
         ...
         # See remote/src/test/resources/aeron.properties
         # advanced.aeron.embedded-media-driver = off
         # advanced.aeron.aeron-dir = "remote/target/aeron"
...
abstract class MaxThroughputSpec extends RemotingMultiNodeSpec(MaxThroughputSpec) with PerfFlamesSupport {
  ...
  val totalMessagesFactor =
    system.settings.config.getDouble("org.apache.pekko.test.MaxThroughputSpec.totalMessagesFactor")
  val realMessage = system.settings.config.getBoolean("org.apache.pekko.test.MaxThroughputSpec.real-message")
  val actorSelection = system.settings.config.getBoolean("org.apache.pekko.test.MaxThroughputSpec.actor-selection")
