...
public final class QueryMessages extends org.apache.pekko.protobufv3.internal.GeneratedFile {
  ...
  public static final class EventEnvelope
    ...
    public int getSerializedSize() {
      ...
      if (((bitField0_ & 0x00000200) != 0)) {
        size +=
            org.apache.pekko.protobufv3.internal.CodedOutputStream.computeBoolSize(10, filtered_);
      }
      if (((bitField0_ & 0x00000400) != 0)) {
        size +=
    ...
    public int hashCode() {
      ...
      if (hasFiltered()) {
        ...
        hash =
            (53 * hash) + org.apache.pekko.protobufv3.internal.Internal.hashBoolean(getFiltered());
      }
      if (hasSource()) {
    ...
    public static final class Builder
       ...
       * @return This builder for chaining.
       */
      public Builder setSourceBytes(org.apache.pekko.protobufv3.internal.ByteString value) {
        if (value == null) {
          throw new NullPointerException();
        }
        source_ = value;
