...
import pekko.persistence.query.typed.scaladsl.EventsBySliceStartingFromSnapshotsQuery
 ...
 * INTERNAL API
 */
@InternalApi private[pekko] class EventsBySliceFirehose(system: ActorSystem) extends Extension {
