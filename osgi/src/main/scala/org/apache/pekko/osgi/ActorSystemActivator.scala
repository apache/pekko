...
abstract class ActorSystemActivator extends BundleActivator {
  ...
  /**
   * By default, the [[pekko.actor.ActorSystem]] name will be set to `bundle-&lt;bundle id&gt;-ActorSystem`.  Override this
   * method to define another name for your [[pekko.actor.ActorSystem]] instance.
   *
   * @param context the bundle context
