---
project.description: Share data between nodes and perform updates without coordination in an Apache Pekko Cluster using Conflict Free Replicated Data Types CRDT.
---
# Distributed Data
...
`pekko.cluster.distributed-data.durable.pruning-marker-time-to-live` and is in the magnitude of days.
