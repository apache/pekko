...
@apidoc[Source.zipN](Source$) { scala="#zipN[T](sources:Seq[org.apache.pekko.stream.scaladsl.Source[T,_]]):org.apache.pekko.stream.scaladsl.Source[Seq[T],org.apache.pekko.NotUsed]" java="#zipN(java.util.List)" } 
