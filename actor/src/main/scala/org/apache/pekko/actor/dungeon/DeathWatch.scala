...
private[pekko] trait DeathWatch { this: ActorCell =>
  ...
  /**
   * When this actor is watching the subject of [[pekko.actor.Terminated]] message
  ...
  private[pekko] def terminatedQueuedFor(subject: ActorRef, customMessage: Option[Any]): Unit =
