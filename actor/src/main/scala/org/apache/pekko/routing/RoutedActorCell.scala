 ...
 * INTERNAL API
 */
private[pekko] object RoutedActorCell {
...
private[pekko] class RoutedActorCell(
  ...
  private[pekko] val routerConfig = _routerProps.routerConfig
 ...
 * INTERNAL API
 */
private[pekko] class RouterPoolActor(override val supervisorStrategy: SupervisorStrategy) extends RouterActor {
