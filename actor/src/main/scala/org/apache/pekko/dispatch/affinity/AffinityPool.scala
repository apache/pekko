...
@InternalApi
@ApiMayChange
private[pekko] final class AffinityPoolConfigurator(config: Config, prerequisites: DispatcherPrerequisites)
...
@InternalApi
@ApiMayChange
private[pekko] final class ThrowOnOverflowRejectionHandler extends RejectionHandlerFactory with RejectionHandler {
