 ...
 */
@FunctionalInterface
@deprecated("Will be removed in favor of pekko.japi.function.Function in Pekko 2.0.0", "Pekko 1.2.0")
trait Function[T, R] {
 ...
 */
@FunctionalInterface
@deprecated("Will be removed in favor of pekko.japi.function.Function2 in Pekko 2.0.0", "Pekko 1.2.0")
 ...
 */
@FunctionalInterface
@deprecated("Will be removed in favor of pekko.japi.function.Procedure in Pekko 2.0.0", "Pekko 1.2.0")
trait Procedure[T] {
  @throws(classOf[Exception])
 ...
 */
@FunctionalInterface
@deprecated("Will be removed in favor of pekko.japi.function.Effect in Pekko 2.0.0", "Pekko 1.2.0")
trait Effect {
  @throws(classOf[Exception])
  def apply(): Unit
}
 ...
 */
@FunctionalInterface
@deprecated("Will be removed in favor of pekko.japi.function.Predicate in Pekko 2.0.0", "Pekko 1.2.0")
trait Predicate[T] {
...
@SerialVersionUID(1L)
@FunctionalInterface
@deprecated("Will be removed in favor of pekko.japi.function.Creator in Pekko 2.0.0", "Pekko 1.2.0")
