...
trait BaseSerializer extends Serializer {
   ...
   */
  @InternalApi
  private[pekko] def identifierFromConfig: Int =
...
object BaseSerializer {
  ...
  /** INTERNAL API */
  @InternalApi
  private[pekko] def identifierFromConfig(bindingName: String, system: ExtendedActorSystem): Int =
...
/**
 * This Serializer is used when `org.apache.pekko.actor.java-serialization = off`
 */
