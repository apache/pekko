...
class Serialization(val system: ExtendedActorSystem) extends Extension {
   ...
   *
   * Throws org.apache.pekko.ConfigurationException if no `serialization-bindings` is configured for the
   *   class of the object.
   */
  ...
  /**
   * A Map of serializer from alias to implementation (class implementing org.apache.pekko.serialization.Serializer)
   * By default always contains the following mapping: "java" -> org.apache.pekko.serialization.JavaSerializer
   */
