 ...
 * INTERNAL API
 */
@InternalApi private[pekko] abstract class ByteStringParser[T] extends GraphStage[FlowShape[ByteString, T]] {
 ...
 * INTERNAL API
 */
@InternalApi private[pekko] object ByteStringParser {
