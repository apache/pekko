 ...
 * INTERNAL API
 */
@InternalApi private[pekko] object DowningStrategy {
 ...
 * INTERNAL API
 */
@InternalApi private[pekko] abstract class DowningStrategy(val selfDc: DataCenter, selfUniqueAddress: UniqueAddress) {
